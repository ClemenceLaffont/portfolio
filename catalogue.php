...
<main class="main-view" id="catalogue">
    <h2>Mes Projets !</h2>
    <?php
    $json = file_get_contents("db/projets.json");
    ...
    ?>
        ...
        <!-- %%%%%%%%% -->
            ...
            <section class="miniature" style="background-image:url('<?php echo $projet->img; ?>');" alt="miniature graphique représentant le projet <?php echo $projet->nom; ?>">
                <section class="hoverprojet" tabindex="0">
                    <a href="<?php echo $projet->url; ?>" target="_blank">
        ...
        <!-- %%%%% -->
            ...
            <section class="popup" style="display:none;" id="<?php echo $projet->nom; ?>">
                    <div class="gauche">
                    ...
                    <div class="centre">
                        ...
                        <section class="description">
                            <img src="<?php echo $projet->img; ?>" alt="miniature graphique représentant le projet <?php echo $projet->nom; ?>"/>
                            <section>
                                <h3><?php echo $projet->nom; ?></h3>
                                <p><strong>Date de création :</strong> <?php echo $projet->date; ?></p>
                                <p><strong>Langages :</strong> <?php echo $projet->langue; ?></p>
                                <p><strong>Consept vue ou appris :</strong> <?php echo $projet->concept; ?></p>
                            </section>
                        </section>
                        <p><strong>Description :</strong> <?php echo $projet->commentaire; ?></p>
                        <section class="placebouton">
                            <a href="<?php echo $projet->url; ?>" class="boutonperso" target="_blank">GO ON WEBSITE !</a>
                            <a href="https://github.com/ClemenceLaffont/<?php echo $projet->nom; ?>" class="boutonperso" target="_blank">GO ON GITHUB !</a>
                        </section>
                    </div>
                    <div class="droite">
