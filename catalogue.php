                ...
                <div class="centre">
                    ...
                    <section class="description">
                        ...
                        <section>
                            ...
                            <p><strong>Consept vue ou appris :</strong> Création d'un enfant de theme wordpress, Création de nouveau template, modification durable du css, rechercher et manipuler un plugin, contenter un client</p>
                        </section>
                    </section>
                    <p><strong>Description :</strong> Dans le cadre de notre formation, une semaine a été alouer a l'elaboration d'un projet wordpress pour un client donné, gratuitement et sans engagement de réussite. J'étais dans un groupe de 3 avec Valentin Sorlin et Maelle LaLicorn et notre cliente était Irène Pédrinis, une assistante maternelle désireuse d'avoir son propre blog. N'ayant tout les trois aucun probleme dans l'apprentissage des nouveaux langages, le projet fut terminé rapidement et sans encombre, nous laissant meme le temps le vendredi d'aller chez la cliente pour lui présenter le produit fini et lui apprendre à l'utiliser. </p>
                    <section class="placebouton">
                        <a href="https://nounou-irene.000webhostapp.com/" class="boutonperso" target="_blank">GO ON WEBSITE !</a>
                        <a href="https://github.com/ClemenceLaffont" class="boutonperso" target="_blank">GO ON GITHUB !</a>
                    </section>
                </div>
                <div class="droite">
