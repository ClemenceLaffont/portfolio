...
<main id="accueil">
    ...
    <nav>
        <h1>Clémence Laffont,</h1>
        <p>developpeuse web fullstack junior à la recherche d'une entreprise cool ! Je suis aussi graphiste stellaire à mes heures perdu !</p>
        <a href="catalogue.php" class="nav_index">Présentation</a>
        ...
        <section>
            ...
            <a href="https://twitter.com/ClemenceLaffont"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
