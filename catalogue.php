...
<main class="main-view" id="catalogue">
...
<!-- %%%%%%%%%%%% -->
    ...
    <section class='projets'>
        <section class="miniature" style="background-image:url('img/miniature-irene.png');">
            <section class="hoverprojet" >
                <a href="https://nounou-irene.000webhostapp.com/" target="_blank">
        ...
        <section class="popup" style="display:none;" id="nounou-irene">
                <div class="gauche">
                ...
                <div class="centre">
                    ...
                    <section class="description">
                        ...
                        <section>
                            <h3>Nounou Irène</h3>
                            <p><strong>Date de création :</strong> Septembre 2017</p>
                            <p><strong>Langages :</strong> WordPress, php, html, css</p>
                            <p><strong>Concepts vus ou appris :</strong> Création d'un enfant de thème wordpress, création de nouveaux templates, modification du css, rechercher et manipuler un plugin, contenter le client.</p>
                        </section>
                    </section>
                    <p><strong>Description :</strong> Dans le cadre de notre formation, une semaine a été alouée à l'élaboration d'un projet wordpress pour un client donné, gratuitement et sans engagement de réussite. J'étais dans un groupe de 3 avec Valentin Sorlin et Maëlle LaLicorne et notre cliente était Irène Pédrinis, une assistante maternelle désireuse d'avoir son propre blog. Le projet fut terminé rapidement et sans encombre, nous laissant même le temps le dernier jour d'aller chez la cliente pour lui présenter le produit fini et lui apprendre à l'utiliser. La cliente fut entièrement satisfaite du blog ! </p>
                    <section class="placebouton">
                        <a href="https://nounou-irene.000webhostapp.com/" class="boutonperso" target="_blank">GO ON WEBSITE !</a>
                    </section>
                </div>
                <div class="droite">
...
<!-- %%%%%%%%% -->
    ...
    <section class='projets'>
        <section class="miniature" style="background-image:url('img/miniature-goldnord.png');">
            <section class="hoverprojet" >
                <a href="https://goldnord.fr/" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 125" version="1.1" x="0px" y="0px">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g stroke-width="14" stroke="#ffffff"><polyline transform="translate(50.000000, 64.004272) rotate(45.000000) translate(-50.000000, -64.004272) " points="30 84.0042725 30 44.0042725 30 44.0042725 70 44.0042725"/></g></g>
                    </svg>
                    <p>Visiter le site</p>
                ...
                <div>
                    <h3>Gold Nord</h3>
                    <p>Ergonomie, Design, Photoshop</p>
                </div>
                <div class="plus">
                    <div>
                        <p>En savoir&nbsp;</p>
                ...
                <div class="centre">
                    ...
                    <section class="description">
                        ...
                        <section>
                            ...
                            <p><strong>Langages :</strong> Ergonomie, Design, Photoshop</p>
                            <p><strong>Concepts vus ou appris :</strong> Réunions client, collaboration avec des personnes ayant des compétences totalement différentes, maquettage, ergonomie, refonte logo et charte graphique.</p>
                        </section>
                    </section>
                    <p><strong>Description :</strong> Seul gros projet que j'ai eu à réaliser en tant qu'infographiste indépendante. J'étais au sein d'une équipe composée d'un développeur web, d'une consultante en communication et image de l'entreprise et d'un consultant SEO, tous independants. Gold Nord voulait moderniser son image et améliorer sa plateforme web tout en conservant le plus possible sa popularité et son référencement acquis. J'ai travaillé en tout premier sur la refonte du logo et de la charte graphique en collaboration avec la consultante com. Puis j'ai attaqué la maquette du site web ainsi que la réécriture de la plupart des textes avec le dev. Enfin, j'ai terminé toute seul la déclinaison de la charte sur les differents supports utiles (papeterie, brochure, flyers, stop trottoir, autocollant vitrine ...).</p>
                    <section class="placebouton">
                        <a href="https://goldnord.fr/" class="boutonperso" target="_blank">GO ON WEBSITE !</a>
                    </section>
                </div>
                <div class="droite">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 24 30" style="enable-background:new 0 0 24 24;" xml:space="preserve"><g><polygon fill="#ffffff" points="11.019,7.659 15.36,12.048 11.013,16.347 9.943,15.265 13.207,12.036 9.937,8.73  "/><path fill="#ffffff" d="M3.628,12c0,4.617,3.756,8.372,8.372,8.372s8.372-3.755,8.372-8.372S16.616,3.628,12,3.628S3.628,7.384,3.628,12z M5.15,12   c0-3.777,3.073-6.85,6.85-6.85s6.85,3.073,6.85,6.85s-3.073,6.85-6.85,6.85S5.15,15.777,5.15,12z"/></g></svg>
    ...
    <section class="projetmobile">
        <div class="separationmobile"></div>
        <img src="img/miniature-goldnord.png"/>
        <h3>Gold Nord</h3>
        <p><strong>Date de création :</strong> Fevrier - Juillet 2016</p>
        <p><strong>Langages :</strong> Ergonomie, Design, Photoshop</p>
        <p><strong>Concept vus ou appris :</strong> Réunions client, collaboration avec des personnes ayant des compétences totalement différentes, maquettage, ergonomie, refonte logo et charte graphique.</p>
        <p><strong>Description :</strong> Seul gros projet que j'ai eu à réaliser en tant qu'infographiste indépendante. J'étais au sein d'une équipe composée d'un développeur web, d'une consultante en communication et image de l'entreprise et d'un consultant SEO, tous independants. Gold Nord voulait moderniser son image et améliorer sa plateforme web tout en conservant le plus possible sa popularité et son référencement acquis. J'ai travaillé en tout premier sur la refonte du logo et de la charte graphique en collaboration avec la consultante com. Puis j'ai attaqué la maquette du site web ainsi que la réécriture de la plupart des textes avec le dev. Enfin, j'ai terminé toute seul la déclinaison de la charte sur les differents supports utiles (papeterie, brochure, flyers, stop trottoir, autocollant vitrine ...).</p>
        <a href="https://goldnord.fr/" class="boutonperso" target="_blank">GO ON WEBSITE !</a>
    </section>
